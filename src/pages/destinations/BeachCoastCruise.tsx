...
export default function BeachCoastCruise() {
  ...
  const testimonials = [
    {
      text: "The Beach & Coast cruise was absolutely stunning, especially at sunset! The views of Fort Lauderdale Beach and A1A from the water are incredible. Perfect for a romantic evening or celebrating with friends.",
      name: "Robert Williams",
      rating: 5
    },
    {
      text: "We did the sunset cruise and it was magical! The coastal views, the beach atmosphere, and the beautiful sunset made for an unforgettable experience. Highly recommend this route for anyone who loves coastal scenery.",
      name: "Lisa Anderson",
      rating: 5
    }
  ];
        ...
        <div className="relative w-full flex items-center justify-center px-4 sm:px-6 pt-32 sm:pt-36 md:pt-28 pb-12 md:pb-0">
          <div className="text-center text-white max-w-4xl mx-auto w-full">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold mb-4 sm:mb-6 tracking-tight leading-tight">
              Fort Lauderdale Beach & Coast Cruise
            </h1>
            <div className="flex flex-wrap items-center justify-center gap-4 sm:gap-6 mb-8">
            <div className="text-4xl sm:text-5xl font-bold text-coral price-text">$1,200</div>
      ...
      <div className="bg-sand/30 py-3 px-4">
        <div className="max-w-7xl mx-auto text-sm text-ocean/70">
          <div className="flex items-center gap-2">
            ...
            <ChevronRight className="w-4 h-4" />
            <span className="text-ocean">Beach & Coast Cruise</span>
          </div>
        </div>
      </div>
      ...
      <section className="py-6 sm:py-8 px-4 bg-white border-b border-ocean/10">
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
          <div className="bg-sand/40 rounded-xl p-4">
            ...
            <div className="text-xl font-bold text-ocean">3 Hours</div>
          </div>
          <div className="bg-sand/40 rounded-xl p-4">
          ...
          <div className="bg-sand/40 rounded-xl p-4">
            ...
            <div className="text-xl font-bold text-coral price-text">$1,200</div>
          </div>
        </div>
      ...
      <section className="py-12 sm:py-16 md:py-20 px-4 bg-white">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-ocean mb-6 sm:mb-8 text-center">
            Cruise Along Fort Lauderdale's Stunning Coastline
          </h2>
          <div className="prose prose-lg max-w-none text-ocean/80 space-y-4 text-base sm:text-lg leading-relaxed">
            <p>
              Experience Fort Lauderdale's stunning beach coastline with views of the famous beach and A1A. This 3-hour coastal cruise offers the perfect blend of ocean breezes, beach views, and beautiful sunset opportunities.
            </p>
            <p>
              Cruise along the coast, watch beachgoers and surfers, and enjoy the vibrant atmosphere of Fort Lauderdale's beach scene from the comfort of your private tiki pontoon. Perfect for sunset cruises with spectacular photo opportunities.
            </p>
            <p>
              This route is ideal for those who love coastal views, sunset watching, and the energetic vibe of Fort Lauderdale's beachfront. Your captain will navigate the best viewing spots for an unforgettable coastal experience.
            </p>
          </div>
          ...
          <div className="mt-10 sm:mt-12 bg-ocean/5 rounded-2xl p-6 sm:p-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              {['Beach views', 'Coastal cruising', 'Perfect for sunsets'].map((highlight, index) => (
          ...
          <div className="mt-8 text-center">
            <div className="inline-block bg-coral/10 border-2 border-coral rounded-xl px-6 py-4">
              <div className="text-2xl sm:text-3xl font-bold text-coral mb-2 price-text">$1,200</div>
              <div className="text-ocean/70 text-sm sm:text-base">3 Hours | Up to 18 Guests</div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="text-xl font-bold text-ocean mb-2">Hour 1: Departure & Initial Coast Cruise</h3>
                <p className="text-ocean/70 leading-relaxed">Depart from The Hilton Marina and begin your coastal journey. Cruise along Fort Lauderdale's stunning coastline, taking in views of the famous beach and A1A. Feel the ocean breezes as you enjoy the vibrant beach scene from the water.</p>
              </div>
            </div>
            <div className="flex gap-4">
              <div className="flex-shrink-0">
                <div className="w-12 h-12 bg-coral rounded-full flex items-center justify-center text-white font-bold text-lg">2</div>
              </div>
              <div>
                <h3 className="text-xl font-bold text-ocean mb-2">Hour 2: Beach Views & Coastal Highlights</h3>
                <p className="text-ocean/70 leading-relaxed">Experience the full beauty of Fort Lauderdale's beachfront. Watch beachgoers and surfers, enjoy the coastal atmosphere, and take in spectacular views. Your captain will navigate to the best viewing spots for photos and sightseeing.</p>
              </div>
            </div>
            <div className="flex gap-4">
              <div className="flex-shrink-0">
                <div className="w-12 h-12 bg-coral rounded-full flex items-center justify-center text-white font-bold text-lg">3</div>
              </div>
              <div>
                <h3 className="text-xl font-bold text-ocean mb-2">Hour 3: Return Journey & Sunset Views</h3>
                <p className="text-ocean/70 leading-relaxed">Enjoy a beautiful cruise back to The Hilton Marina. If timed for sunset, you'll experience spectacular sunset views over the coastline, making for an unforgettable end to your coastal adventure.</p>
              </div>
            </div>
          </div>
        </div>
