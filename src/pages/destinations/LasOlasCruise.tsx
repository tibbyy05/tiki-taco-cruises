...
export default function LasOlasCruise() {
  ...
  const relatedRoutes = [
    ...
    {
      name: 'Beach & Coast Cruise',
      url: '/routes/beach-coast-cruise',
      duration: '3 Hours',
      price: '$1,200',
      ...
      <section className="relative min-h-[70vh] sm:min-h-[80vh] w-full overflow-hidden flex items-center">
        <div className="absolute inset-0">
          <img
            ...
            alt="Las Olas & Intracoastal Cruise"
      ...
      <div className="bg-sand/30 py-3 px-4">
        <div className="max-w-7xl mx-auto text-sm text-ocean/70">
          <div className="flex items-center gap-2">
            ...
            <ChevronRight className="w-4 h-4" />
            <span className="text-ocean">Las Olas & Intracoastal Cruise</span>
          </div>
        </div>
      </div>
      ...
      <section className="py-12 sm:py-16 md:py-20 px-4 bg-white">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-ocean mb-6 sm:mb-8 text-center">
            Experience Fort Lauderdale's Most Iconic Waterway
          </h2>
          <div className="prose prose-lg max-w-none text-ocean/80 space-y-4 text-base sm:text-lg leading-relaxed">
            <p>
              Cruise through Fort Lauderdale's famous Intracoastal Waterway aboard our luxury tiki pontoon. This 3-hour journey takes you past magnificent waterfront estates, mega yachts, and the vibrant Las Olas Boulevard area.
            </p>
            <p>
          ...
          <div className="mt-10 sm:mt-12 bg-ocean/5 rounded-2xl p-6 sm:p-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              {['Las Olas views', 'Luxury waterfront homes', 'Perfect for sightseeing'].map((highlight, index) => (
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="text-xl font-bold text-ocean mb-2">Hour 1: Departure & Initial Cruise</h3>
                <p className="text-ocean/70 leading-relaxed">Depart from The Hilton Marina and begin your journey along the Intracoastal Waterway. Take in the stunning views as you cruise past luxury waterfront properties and mega yachts.</p>
              </div>
            </div>
            <div className="flex gap-4">
              <div className="flex-shrink-0">
              ...
              <div>
                <h3 className="text-xl font-bold text-ocean mb-2">Hour 2: Las Olas Boulevard & Waterfront Estates</h3>
                <p className="text-ocean/70 leading-relaxed">Experience the vibrant Las Olas Boulevard area from the water, cruise past magnificent waterfront estates, and see why Fort Lauderdale is known as the Venice of America.</p>
              </div>
            </div>
            <div className="flex gap-4">
              <div className="flex-shrink-0">
              ...
              <div>
                <h3 className="text-xl font-bold text-ocean mb-2">Hour 3: Return Journey</h3>
                <p className="text-ocean/70 leading-relaxed">Enjoy a relaxing cruise back to The Hilton Marina, taking in any sights you may have missed and enjoying the beautiful Fort Lauderdale waterways.</p>
              </div>
            </div>
          </div>
        </div>
