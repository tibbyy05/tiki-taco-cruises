  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-sand">
        <section className="relative bg-navy text-white pt-32 pb-16 sm:pt-40 sm:pb-20">
        ...
        <section className="max-w-6xl mx-auto px-4 py-12 sm:py-16">
          {posts.length === 0 ? (
            <div className="bg-white rounded-2xl shadow-lg border border-navy/10 p-12 text-center">
              ...
              {posts.map((post) => (
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <h2 className="text-xl font-bold text-navy mb-2 group-hover:text-coral transition-colors">
                      {post.title}
                    </h2>
                    {post.excerpt && (
                    ...
                    <p className="mt-4 text-sm font-semibold text-coral group-hover:underline">
                      Read more →
                    </p>
                  </div>
                </Link>
